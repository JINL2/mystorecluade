...
export class ShipmentModel {
  ...
  /**
   * Map RPC response to ShipmentDetail (v2: variant support)
   */
  static fromRpcDetail(data: ShipmentDetail): ShipmentDetail {
    return {
      ...
      // v2: receiving_summary field
      receiving_summary: data.receiving_summary,
      has_orders: data.has_orders || false,
  ...
  /**
   * Map RPC detail item (v2: variant support)
   */
  static fromRpcDetailItem(data: ShipmentDetailItem): ShipmentDetailItem {
    return {
      ...
      display_name: data.display_name || data.product_name,
  ...
  /**
   * Map NewShipmentItem to RPC item format (v3: variant support)
   */
  ...
  /**
   * Map array of NewShipmentItem to RPC format (v3: variant support)
   */
  ...
  /**
   * Map InventoryProduct to NewShipmentItem (v6: variant support)
   */
  ...
  /**
   * Check if shipment item already exists by product ID + variant ID (v6: variant support)
   */
