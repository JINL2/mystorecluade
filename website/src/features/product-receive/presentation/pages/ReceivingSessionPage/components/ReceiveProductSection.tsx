/**
 * ReceiveProductSection Component
 * Section for searching and adding products to receive
 */

import React from 'react';
import type { SearchProduct, ReceivedEntry } from '../../../hooks/useReceivingSession';
import searchStyles from './SearchBox.module.css';
import entriesStyles from './ReceivedEntries.module.css';

// Merge styles from both modules
const styles = { ...searchStyles, ...entriesStyles };

interface ReceiveProductSectionProps {
  searchQuery: string;
  ...
  onSetQuantity: (entryId: string, quantity: number) => void;
...
export const ReceiveProductSection: React.FC<ReceiveProductSectionProps> = ({
  searchQuery,
  setSearchQuery,
  searchResults,
  isSearching,
    ...
    <div className={styles.receiveSection}>
      ...
      {saveError && (
        <div className={styles.saveErrorMessage}>
          ...
          {saveError}
          <button onClick={onDismissSaveError} className={styles.dismissButton}>×</button>
        </div>
      )}
      {saveSuccess && (
