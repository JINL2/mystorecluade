      ...
      dropdown: [
        {
          ...
          items: [
            ...
            { label: 'Shipment', href: '/product/shipment', action: 'Shipment' },
            { label: 'Session', href: '/product/session', action: 'Session' },
      ...
      dropdown: [
        {
          ...
          items: [{ label: 'Inventory Analysis', href: '/analysis/inventory-analysis', action: 'Inventory Analysis' }],
        },
      ],
    },
    {
      ...
      dropdown: [
        {
          ...
          items: [
            ...
            { label: 'Cash Balance', href: '/finance/cash-balance', action: 'Cash Balance' },
          ],
        },
        {
  ...
  useEffect(() => {
    const detectPageAction = () => {
      ...
      const pathMappings: { [key: string]: string } = {
        ...
        'finance/cash-balance': 'Cash Balance',
        ...
        'analysis/inventory-analysis': 'Inventory Analysis',
