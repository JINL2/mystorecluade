...
import 'user_timetable_schedule_model.dart';
export 'user_timetable_schedule_model.dart';

class UserTimetableScheduleWidget extends StatefulWidget {
  const UserTimetableScheduleWidget({
    super.key,
    this.cardInfo,
    this.action,
  });
  ...
  @override
  State<UserTimetableScheduleWidget> createState() =>
      _UserTimetableScheduleWidgetState();
}

class _UserTimetableScheduleWidgetState
    extends State<UserTimetableScheduleWidget> {
  late UserTimetableScheduleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserTimetableScheduleModel());
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: (functions.convertJsonToString(getJsonField(
                                      widget.cardInfo,
                                      r'''$.is_reported''',
                                    )) ==
                                    'true'
                        ...
                        text: functions.convertJsonToString(getJsonField(
                                  widget.cardInfo,
                                  r'''$.is_reported''',
                                )) ==
                                'true'
