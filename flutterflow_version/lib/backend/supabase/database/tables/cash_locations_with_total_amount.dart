...
class CashLocationsWithTotalAmountTable
    extends SupabaseTable<CashLocationsWithTotalAmountRow> {
  @override
  String get tableName => 'cash_locations_with_total_amount';

  @override
  CashLocationsWithTotalAmountRow createRow(Map<String, dynamic> data) =>
      CashLocationsWithTotalAmountRow(data);
}

class CashLocationsWithTotalAmountRow extends SupabaseDataRow {
  CashLocationsWithTotalAmountRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CashLocationsWithTotalAmountTable();
