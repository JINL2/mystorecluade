...
class VBankAmountTable extends SupabaseTable<VBankAmountRow> {
  @override
  String get tableName => 'v_bank_amount';

  @override
  VBankAmountRow createRow(Map<String, dynamic> data) => VBankAmountRow(data);
}

class VBankAmountRow extends SupabaseDataRow {
  VBankAmountRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VBankAmountTable();
