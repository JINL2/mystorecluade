...
class ApprovedEmployeesStruct extends BaseStruct {
  ...
  static ApprovedEmployeesStruct fromMap(Map<String, dynamic> data) =>
      ApprovedEmployeesStruct(
  ...
  static ApprovedEmployeesStruct? maybeFromMap(dynamic data) => data is Map
      ? ApprovedEmployeesStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ApprovedEmployeesStruct fromSerializableMap(
  ...
  @override
  String toString() => 'ApprovedEmployeesStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ApprovedEmployeesStruct &&
        userId == other.userId &&
...
ApprovedEmployeesStruct createApprovedEmployeesStruct({
  String? userId,
  String? userName,
  bool? isApproved,
  String? shiftRequestId,
