...
import 'edit_schedule1_model.dart';
export 'edit_schedule1_model.dart';

class EditSchedule1Widget extends StatefulWidget {
  const EditSchedule1Widget({
    super.key,
    this.shiftRequestId,
  ...
  final ApprovedEmployeesStruct? approvedEmployeeData;
  final ManagerShiftDetailStruct? managerShiftDetail;
  final VShiftRequestRow? supabaseCall;

  @override
  State<EditSchedule1Widget> createState() => _EditSchedule1WidgetState();
}

class _EditSchedule1WidgetState extends State<EditSchedule1Widget> {
  late EditSchedule1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditSchedule1Model());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.isLateBoolean = widget.supabaseCall?.isLate;
      _model.shiftId = widget.supabaseCall?.shiftId;
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      widget.managerShiftDetail?.requestDate,
                                      'yyyy-MM-dd',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                  ...
                                  children: [
                                    Icon(
                                      ...
                                      color: valueOrDefault<Color>(
                                        _model.isLateBoolean != null
                                            ? (_model.isLateBoolean!
                                                ? FlutterFlowTheme.of(context)
                                                    .tertiary
                                                : FlutterFlowTheme.of(context)
                                                    .secondary)
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Indicate if employee arrived late to their shift',
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                                      font: GoogleFonts.notoSansJp(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Adjust payable hours for this shift',
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                                      font: GoogleFonts.notoSansJp(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller:
                                        _model.incentiveTextFieldTextController,
                                    focusNode:
                                        _model.incentiveTextFieldFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      hintText: 'Type Incentive',
                            ...
                            onPressed: () async {
                              if (FFAppState().isLoading1 == false) {
                                ...
                                await ShiftRequestsTable().update(
                                  data: {
                                    'is_late': _model.isLateBoolean,
                                    'bonus_amount': _model.incentiveTextFieldTextController
                                                    .text !=
                                                ''
