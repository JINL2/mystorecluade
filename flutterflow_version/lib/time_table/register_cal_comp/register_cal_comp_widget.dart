...
import 'register_cal_comp_model.dart';
export 'register_cal_comp_model.dart';
...
class RegisterCalCompWidget extends StatefulWidget {
  ...
  @override
  State<RegisterCalCompWidget> createState() => _RegisterCalCompWidgetState();
}

class _RegisterCalCompWidgetState extends State<RegisterCalCompWidget> {
  late RegisterCalCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisterCalCompModel());
                                  ...
                                  if (FFAppState()
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        height: 5.0,
                                        decoration: BoxDecoration(
                                          color: functions.isAnyApprovedForDate(
                                                  FFAppState()
                                                      .shiftStatus
                                                      .toList(),
                                                  dateTimeFormat(
