...
import 'time_table_user_model.dart';
export 'time_table_user_model.dart';

class TimeTableUserWidget extends StatefulWidget {
  const TimeTableUserWidget({super.key});

  static String routeName = 'timeTableUser';
  static String routePath = '/timeTableUser';

  @override
  State<TimeTableUserWidget> createState() => _TimeTableUserWidgetState();
}

class _TimeTableUserWidgetState extends State<TimeTableUserWidget>
    with TickerProviderStateMixin {
  late TimeTableUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimeTableUserModel());
