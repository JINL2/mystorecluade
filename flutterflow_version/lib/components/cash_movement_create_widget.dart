...
import 'cash_movement_create_model.dart';
export 'cash_movement_create_model.dart';

class CashMovementCreateWidget extends StatefulWidget {
  const CashMovementCreateWidget({
    super.key,
    this.transacDetail,
  });
  ...
  @override
  State<CashMovementCreateWidget> createState() =>
      _CashMovementCreateWidgetState();
}

class _CashMovementCreateWidgetState extends State<CashMovementCreateWidget> {
  late CashMovementCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CashMovementCreateModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<CashLocationsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CashLocationsRow> containerCashLocationsRowList = snapshot.data!;
                ...
                children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller:
                                _model.debutCashlocationValueController ??=
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model.creditLocationValueController ??=
                                FormFieldController<String>(
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        _model.addToTransactionDetail(TransactionDetailStruct(
                          accountId: 'd4a7a16e-45a1-47fe-992b-ff807c8673f0',
                          description: _model.textController2.text,
                          cash: CashStruct(
                            cashLocationId: _model.debutCashlocationValue,
                          ),
                          debit: '0',
                          credit: '0',
                          amount: 0.0,
                        ...
                        safeSetState(() {});
                        _model.apiResult00c = await CreateTamplateCall.call(
                          pCompanyId: FFAppState().companyChoosen,
                          pStoreId: FFAppState().storeChoosen,
                          pName: _model.cashLocationNameTextController.text,
                          pDataJson: functions.mapTransactionDetailtoObject(
                              _model.transactionDetail.toList()),
                        );

                        if ((_model.apiResult00c?.succeeded ?? true)) {
                          await showDialog(
                            context: context,
