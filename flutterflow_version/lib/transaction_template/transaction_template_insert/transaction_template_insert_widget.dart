...
import 'transaction_template_insert_model.dart';
export 'transaction_template_insert_model.dart';

class TransactionTemplateInsertWidget extends StatefulWidget {
  const TransactionTemplateInsertWidget({
    super.key,
    this.transacDetail,
  });
  ...
  @override
  State<TransactionTemplateInsertWidget> createState() =>
      _TransactionTemplateInsertWidgetState();
}

class _TransactionTemplateInsertWidgetState
    extends State<TransactionTemplateInsertWidget> {
  late TransactionTemplateInsertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransactionTemplateInsertModel());
