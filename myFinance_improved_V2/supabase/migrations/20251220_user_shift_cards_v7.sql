-- user_shift_cards_v7: manager_memo 추가
-- 변경: manager_memo_v2 필드 추가 - 직원이 매니저가 남긴 메모를 볼 수 있도록
-- 이유: Shift Details 페이지에서 매니저 메모 표시
-- 적용: supabase db execute --file 20251220_user_shift_cards_v7.sql

CREATE OR REPLACE FUNCTION public.user_shift_cards_v7(
