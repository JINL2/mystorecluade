-- ================================================================
-- Migration: Create get_transaction_history_utc RPC Function
-- ================================================================
--
-- Purpose: Create new RPC function that returns timestamptz (_utc) columns
--          instead of timestamp without time zone columns
--
-- Strategy:
--   1. CREATE NEW function with _utc suffix
--   2. Keep original function unchanged
--   3. Return entry_date_utc and created_at_utc columns
--
-- Changes:
--   - entry_date → entry_date_utc
...
BEGIN
    ...
    WITH filtered_entries AS (
        SELECT
            ...
            je.entry_date_utc as entry_date,  -- ✅ CHANGED to _utc
            je.created_at_utc as created_at,  -- ✅ CHANGED to _utc
            je.description,
            je.journal_type,
            je.is_draft,
            je.store_id,
        ...
        GROUP BY
            je.journal_id, je.entry_date_utc, je.created_at_utc, je.description,  -- ✅ CHANGED to _utc
        ...
        ORDER BY je.created_at_utc DESC NULLS LAST  -- ✅ CHANGED to _utc + NULLS LAST
        LIMIT p_limit
        OFFSET p_offset
    ),
