-- Fix duplicate trade_dashboard_timeline functions
-- Drop both versions and create a single one with TEXT type
-- Added: user salary_type and currency info

-- Drop the VARCHAR version
...
-- Create single function with TEXT type
-- Now includes user salary_type and currency info
