...
/// Can be used for currency, percentages, or any numeric value
class TossNumberpadModal extends StatefulWidget {
  final String? title;
  ...
  /// Show numberpad modal and return the entered value
  static Future<String?> show({
    ...
    return showModalBottomSheet<String>(
      ...
      builder: (context) => TossNumberpadModal(
        title: title,
  ...
  @override
  State<TossNumberpadModal> createState() => _TossNumberpadModalState();
}

class _TossNumberpadModalState extends State<TossNumberpadModal> {
  late String _value;
...
/// Helper widget to wrap TextField with numberpad modal
class TossNumberpadField extends StatelessWidget {
