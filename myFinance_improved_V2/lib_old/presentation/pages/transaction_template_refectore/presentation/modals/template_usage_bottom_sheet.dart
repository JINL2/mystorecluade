...
import 'package:myfinance_improved/presentation/providers/app_state_provider.dart' as Legacy;
...
class _TemplateUsageBottomSheetState extends ConsumerState<TemplateUsageBottomSheet> {
  ...
  Widget _buildCashLocationSelector() {
    final selectedStore = ref.watch(Legacy.selectedStoreProvider);
    final storeId = selectedStore != null ? (selectedStore['store_id'] as String?) ?? '' : '';
