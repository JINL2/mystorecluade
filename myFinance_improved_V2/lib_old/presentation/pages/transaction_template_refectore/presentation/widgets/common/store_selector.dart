...
import 'package:myfinance_improved/presentation/providers/entities/counterparty_provider.dart';
...
class _StoreSelectorState extends ConsumerState<StoreSelector> {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ FIXED: Load stores from counterpartyStoresProvider
    final storesAsync = widget.linkedCompanyId != null && widget.linkedCompanyId!.isNotEmpty
        ? ref.watch(counterpartyStoresProvider(widget.linkedCompanyId!))
