...
/// Template data service provider (Data layer internal)
final templateDataServiceProvider = Provider<TemplateDataService>((ref) {
  return TemplateDataService(ref.read(supabaseServiceProvider));
});
