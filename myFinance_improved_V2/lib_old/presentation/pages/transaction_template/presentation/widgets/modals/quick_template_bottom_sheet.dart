...
import '../../../business/validators/quick_template_validator.dart';
import '../../../business/use_cases/create_quick_transaction_use_case.dart';
import '../forms/quick_amount_input.dart';
import '../forms/quick_status_indicator.dart';
import '../forms/essential_selectors.dart';
import '../forms/collapsible_description.dart';
import '../forms/complex_template_card.dart';
...
class _QuickTemplateBottomSheetState extends ConsumerState<QuickTemplateBottomSheet> {
  ...
  Future<void> _handleQuickSubmit() async {
    ...
    try {
      ...
      final useCase = ref.read(createQuickTransactionUseCaseProvider);
