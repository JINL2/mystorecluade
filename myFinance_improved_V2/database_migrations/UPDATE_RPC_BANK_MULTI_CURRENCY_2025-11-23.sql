-- ============================================================================
-- Migration: Add multi-currency support to Bank section in RPC
-- ============================================================================
-- Date: 2025-11-23
-- Purpose: Update get_location_stock_flow_v2 to return exchange rates and
--          denomination_summary for Bank entries
--
-- Changes:
-- - Bank section now returns multi-currency details
-- - Shows original currency amount, exchange rate, and base currency amount
-- - Example: "$500 × 26,224.66 = ₫13,112,330"
-- ============================================================================

DROP FUNCTION IF EXISTS get_location_stock_flow_v2(uuid, uuid, uuid, integer, integer);
...
- Bank: bank_amount (Stock, NO denomination, Multi-Currency support)
- Vault: vault_amount_line (Flow/Stock, has denomination)
- Updated: Added multi-currency details for Bank (2025-11-23)';
