-- ============================================================================
-- FIX: get_location_stock_flow_v2 - Vault Current Quantity 수정
-- ============================================================================
-- Date: 2025-11-23
--
-- 문제:
--   Vault의 current_quantity가 debit - credit (flow)로 계산되어
--   음수 값이 표시되는 문제 발생
--
-- 해결:
--   current_stock_snapshot JSONB에서 실제 재고 수량을 가져옴
--
-- ============================================================================
...
BEGIN
    ...
    actual_flows_data AS (
        ...
        -- ✅ FIX: Use snapshot instead of debit-credit calculation
        -- ========================================
        SELECT
            cae.entry_id as flow_id,
            cae.created_at,
...
- Vault: current_stock_snapshot (Stock from JSONB snapshot) ✅ FIXED';
