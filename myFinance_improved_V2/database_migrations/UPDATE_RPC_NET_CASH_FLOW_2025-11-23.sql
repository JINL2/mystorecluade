-- ============================================================================
-- Migration: Update RPC to use net_cash_flow column
-- ============================================================================
-- Date: 2025-11-23
-- Purpose: Update get_location_stock_flow_v2 RPC to use net_cash_flow instead of total_amount
--
-- Prerequisites:
-- 1. RENAME_TOTAL_AMOUNT_TO_NET_CASH_FLOW_2025-11-23.sql must be run first
-- ============================================================================

-- Step 1: Rename column (if not already done)
-- If this fails, the column has already been renamed - that's OK
DO $$
BEGIN
    IF EXISTS (
        ...
        ALTER TABLE cash_amount_entries RENAME COLUMN total_amount TO net_cash_flow;
...
- Updated to use net_cash_flow column (2025-11-23)';
