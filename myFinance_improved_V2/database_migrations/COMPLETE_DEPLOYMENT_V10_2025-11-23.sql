-- ============================================================================
-- COMPLETE DEPLOYMENT: Column Rename + RPC V10 FINAL
-- ============================================================================
-- File: COMPLETE_DEPLOYMENT_V10_2025-11-23.sql
-- Date: 2025-11-23
--
-- CRITICAL FIX IN V10:
...
--
-- This script performs all necessary steps in the correct order:
--   1. Rename column: total_amount → net_cash_flow
--   2. Drop existing RPC function
--   3. Create new V10 RPC with corrected Vault RECOUNT logic
--
-- DEPLOYMENT:
...
'Net cash flow (증감분): For STOCK method (cash/bank), calculated as balance_after - balance_before. For FLOW method (vault in/out), this is the input amount. For RECOUNT, this is the adjustment amount.';
...
-- ============================================================================
-- STEP 3: Create V10 RPC Function
-- ============================================================================
