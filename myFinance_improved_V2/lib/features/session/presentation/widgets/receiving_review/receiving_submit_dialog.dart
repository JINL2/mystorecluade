...
class ReceivingSubmitDialog extends StatefulWidget {
  ...
  const ReceivingSubmitDialog({
    super.key,
    required this.onSubmit,
  });

  @override
  State<ReceivingSubmitDialog> createState() => _ReceivingSubmitDialogState();
}

class _ReceivingSubmitDialogState extends State<ReceivingSubmitDialog> {
  bool _isFinal = false;
