...
class PerspectiveSummaryCard extends ConsumerWidget {
  final PerspectiveSummary summary;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius:
                          BorderRadius.circular(TossBorderRadius.buttonPill),
                    ),
                    child: Row(
                      children: [
                        const Icon(
              ...
              if (summary.perspectiveType == 'company' &&
                  summary.storeAggregates.isNotEmpty) ...[
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${store.counterpartyCount}p',
                              style: TossTextStyles.small.copyWith(
                                color:
                                    TossColors.textInverse.withValues(alpha: 0.7),
                                fontSize: 9,
                              ),
                            ),
                          ],
