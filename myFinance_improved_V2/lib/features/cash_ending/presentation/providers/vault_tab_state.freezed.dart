...
// Balance Summary (for completion dialog)
  ...
  @override
  String toString() {
    return 'VaultTabState(stockFlows: $stockFlows, locationSummary: $locationSummary, isLoadingFlows: $isLoadingFlows, isSaving: $isSaving, flowsOffset: $flowsOffset, hasMoreFlows: $hasMoreFlows, errorMessage: $errorMessage, balanceSummary: $balanceSummary, showBalanceDialog: $showBalanceDialog)';
  }
...
abstract class _VaultTabState implements VaultTabState {
  const factory _VaultTabState(
      ...
      final String? errorMessage,
      final BalanceSummary? balanceSummary,
      final bool showBalanceDialog}) = _$VaultTabStateImpl;
