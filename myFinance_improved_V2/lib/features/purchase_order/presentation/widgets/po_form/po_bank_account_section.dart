...
class POBankAccountSection extends ConsumerWidget {
  ...
  final ValueChanged<List<String>> onBankAccountsChanged;

  const POBankAccountSection({
    super.key,
    required this.selectedBankAccountIds,
    required this.onBankAccountsChanged,
  });
        ...
        return Column(
          ...
          children: [
            TossDropdown<String>(
              ...
              value: selectedBankAccountIds.isNotEmpty ? selectedBankAccountIds.first : null,
            ...
            if (selectedBankAccountIds.isNotEmpty) ...[
              ...
              Builder(
                builder: (context) {
                  ...
                  return POBankDetailCard(bank: selectedBank);
                },
              ),
            ],
          ],
...
class POBankDetailCard extends StatelessWidget {
  final CashLocation bank;

  const POBankDetailCard({
    super.key,
    required this.bank,
  });
