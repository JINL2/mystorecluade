...
class _EditProductPageState extends ConsumerState<EditProductPage> {
  ...
  Widget _buildBasicInfoSection() {
    return Padding(
      ...
      child: Column(
        children: [
          // Product Status row - styled like other list rows
          _buildProductStatusRow(),
          _buildListRow(
            label: 'SKU',
            value: _sku,
          ...
          Row(
            children: [
              Text(
                ...
                style: TossTextStyles.body.copyWith(
                  fontWeight: FontWeight.w500,
                  color: _isActive ? TossColors.primary : TossColors.gray500,
                ),
              ),
