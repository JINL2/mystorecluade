...
///
/// Used for backward compatibility with global AppState and Hive cache
Map<String, dynamic> convertUserEntityToMap(UserWithCompanies entity) {
  return {
    ...
    'total_store_count': entity.totalStoreCount,
    'total_employee_count': entity.totalEmployeeCount,
    // company_count is the count of OWNED companies (for subscription limit)
    // This comes from RPC and should be preserved in cache
    'company_count': entity.ownedCompanyCount ?? entity.totalCompanyCount,
...
///
/// Used for converting AppState Map back to Entity (from Hive cache)
UserWithCompanies convertMapToUserEntity(Map<String, dynamic> map) {
  return UserWithCompanies(
    ...
    totalStoreCount: map['total_store_count'] as int? ?? 0,
    totalEmployeeCount: map['total_employee_count'] as int? ?? 0,
    // company_count from cache is the OWNED company count (for subscription limit)
    ownedCompanyCount: map['company_count'] as int?,
