...
CreateTransactionResponseDto _$CreateTransactionResponseDtoFromJson(
    Map<String, dynamic> json) {
  return _CreateTransactionResponseDto.fromJson(json);
}

/// @nodoc
mixin _$CreateTransactionResponseDto {
  ...
  /// Serializes this CreateTransactionResponseDto to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateTransactionResponseDto
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateTransactionResponseDtoCopyWith<CreateTransactionResponseDto>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateTransactionResponseDtoCopyWith<$Res> {
  factory $CreateTransactionResponseDtoCopyWith(
          CreateTransactionResponseDto value,
          $Res Function(CreateTransactionResponseDto) then) =
      _$CreateTransactionResponseDtoCopyWithImpl<$Res,
...
/// @nodoc
class _$CreateTransactionResponseDtoCopyWithImpl<$Res,
        $Val extends CreateTransactionResponseDto>
    implements $CreateTransactionResponseDtoCopyWith<$Res> {
  _$CreateTransactionResponseDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateTransactionResponseDtoImplCopyWith<$Res>
    implements $CreateTransactionResponseDtoCopyWith<$Res> {
  factory _$$CreateTransactionResponseDtoImplCopyWith(
          _$CreateTransactionResponseDtoImpl value,
          $Res Function(_$CreateTransactionResponseDtoImpl) then) =
      __$$CreateTransactionResponseDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool success,
...
/// @nodoc
class __$$CreateTransactionResponseDtoImplCopyWithImpl<$Res>
    extends _$CreateTransactionResponseDtoCopyWithImpl<$Res,
        _$CreateTransactionResponseDtoImpl>
    implements _$$CreateTransactionResponseDtoImplCopyWith<$Res> {
  __$$CreateTransactionResponseDtoImplCopyWithImpl(
      _$CreateTransactionResponseDtoImpl _value,
      $Res Function(_$CreateTransactionResponseDtoImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateTransactionResponseDtoImpl(
      success: null == success
          ? _value.success
          : success // ignore: cast_nullable_to_non_nullable
              as bool,
...
/// @nodoc
@JsonSerializable()
class _$CreateTransactionResponseDtoImpl
    implements _CreateTransactionResponseDto {
  const _$CreateTransactionResponseDtoImpl(
      {required this.success,
  ...
  factory _$CreateTransactionResponseDtoImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateTransactionResponseDtoImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateTransactionResponseDto(success: $success, journalId: $journalId, message: $message, error: $error, field: $field)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateTransactionResponseDtoImpl &&
            (identical(other.success, success) || other.success == success) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, success, journalId, message, error, field);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateTransactionResponseDtoImplCopyWith<
          _$CreateTransactionResponseDtoImpl>
      get copyWith => __$$CreateTransactionResponseDtoImplCopyWithImpl<
          _$CreateTransactionResponseDtoImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateTransactionResponseDtoImplToJson(
      this,
    );
  }
}

abstract class _CreateTransactionResponseDto
    implements CreateTransactionResponseDto {
  const factory _CreateTransactionResponseDto(
      {required final bool success,
      @JsonKey(name: 'journal_id') final String? journalId,
      final String? message,
      final String? error,
      final String? field}) = _$CreateTransactionResponseDtoImpl;

  factory _CreateTransactionResponseDto.fromJson(Map<String, dynamic> json) =
      _$CreateTransactionResponseDtoImpl.fromJson;
