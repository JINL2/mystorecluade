...
_$EmployeeReliabilityDtoImpl _$$EmployeeReliabilityDtoImplFromJson(
    ...
    _$EmployeeReliabilityDtoImpl(
      ...
      avgFillRateApplied: json['avg_fill_rate_applied'] as num? ?? 0,
      reliability: json['reliability'] as num? ?? 0,
      finalScore: json['final_score'] as num? ?? 0,
      applicationsScore: json['applications_score'] as num? ?? 0,
      lateRateScore: json['late_rate_score'] as num? ?? 0,
      lateMinutesScore: json['late_minutes_score'] as num? ?? 0,
      fillRateScore: json['fill_rate_score'] as num? ?? 0,
      salaryAmount: json['salary_amount'] as num? ?? 0,
...
Map<String, dynamic> _$$EmployeeReliabilityDtoImplToJson(
    ...
    <String, dynamic>{
      ...
      'avg_fill_rate_applied': instance.avgFillRateApplied,
      'reliability': instance.reliability,
      'final_score': instance.finalScore,
      'applications_score': instance.applicationsScore,
      'late_rate_score': instance.lateRateScore,
      'late_minutes_score': instance.lateMinutesScore,
      'fill_rate_score': instance.fillRateScore,
