...
class _$RoleImpl extends _Role {
  ...
  @override
  String toString() {
    return 'Role(roleId: $roleId, companyId: $companyId, roleName: $roleName, description: $description, roleType: $roleType, tags: $tags, permissions: $permissions, memberCount: $memberCount, canEdit: $canEdit, canDelegate: $canDelegate, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
