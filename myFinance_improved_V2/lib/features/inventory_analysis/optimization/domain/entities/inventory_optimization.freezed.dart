...
mixin _$ReorderProduct {
  ...
  num get daysLeft =>
      throw _privateConstructorUsedError; // Days of inventory (can be negative)
...
class _$ReorderProductImpl extends _ReorderProduct {
  ...
  @override
  final num daysLeft;
// Days of inventory (can be negative)
  @override
...
abstract class _ReorderProduct extends ReorderProduct {
  ...
  @override
  num get daysLeft; // Days of inventory (can be negative)
  @override
  String get priority;
...
mixin _$OptimizationMetrics {
  num get stockoutRate =>
      throw _privateConstructorUsedError; // Stockout rate (%)
  num get overstockRate =>
      throw _privateConstructorUsedError; // Overstock rate (%)
  num get avgTurnover =>
      throw _privateConstructorUsedError; // Average inventory turnover
...
abstract class _OptimizationMetrics extends OptimizationMetrics {
  ...
  @override
  num get stockoutRate; // Stockout rate (%)
  @override
  num get overstockRate; // Overstock rate (%)
  @override
  num get avgTurnover; // Average inventory turnover
  @override
