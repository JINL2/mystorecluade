...
import '../../../optimization/domain/repositories/inventory_optimization_repository.dart';
...
class HubRepositoryImpl implements HubRepository {
  ...
  final InventoryOptimizationRepository _inventoryRepository;
  final SupplyChainRepository _supplyChainRepository;
  final DiscrepancyRepository _discrepancyRepository;

  HubRepositoryImpl({
    required SalesRepository salesRepository,
    required InventoryOptimizationRepository inventoryRepository,
