...
class AttendanceWeekSchedule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = -3; i <= 3; i++) {
      ...
      final hasData =
          allShiftCardsData.any((card) => card['request_date'] == dateStr);
      final dayCards = allShiftCardsData
          .where((card) => card['request_date'] == dateStr)
          .toList();
      ...
      if (dayCards.isNotEmpty) {
        ...
        hasNonApprovedShift =
            dayCards.any((card) => card['is_approved'] != true);
      }
