...
class ShiftCalendar extends StatelessWidget {
  ...
  final bool Function(DateTime) hasShiftOnDate;
  final Map<String, dynamic>? Function(DateTime) getShiftForDate;
  ...
  const ShiftCalendar({
    ...
    required this.hasShiftOnDate,
    required this.getShiftForDate,
  });
  ...
  Widget build(BuildContext context) {
    ...
    for (int day = 1; day <= daysInMonth; day++) {
      ...
      final hasShift = hasShiftOnDate(date);
      final shiftData = getShiftForDate(date);
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: isSelected
                              ...
                              : userIsApproved
                                  ? TossColors
                                      .success // Green - user is approved
