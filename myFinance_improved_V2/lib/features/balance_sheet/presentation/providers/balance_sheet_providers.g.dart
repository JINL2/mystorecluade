...
String _$storesHash() => r'995314d2e4bf456cfa3aea035898253fb4071486';

/// Stores provider
///
/// Copied from [stores].
@ProviderFor(stores)
const storesProvider = StoresFamily();

/// Stores provider
///
/// Copied from [stores].
class StoresFamily extends Family<AsyncValue<List<Store>>> {
  /// Stores provider
  ///
  /// Copied from [stores].
  const StoresFamily();
  ...
  @override
  StoresProvider getProviderOverride(
    covariant StoresProvider provider,
  ) {
    return call(
      provider.companyId,
    );
  ...
  @override
  String? get name => r'storesProvider';
}

/// Stores provider
///
/// Copied from [stores].
class StoresProvider extends AutoDisposeFutureProvider<List<Store>> {
  /// Stores provider
  ///
  /// Copied from [stores].
  StoresProvider(
    String companyId,
          ...
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$storesHash,
          dependencies: StoresFamily._dependencies,
          allTransitiveDependencies: StoresFamily._allTransitiveDependencies,
          companyId: companyId,
        );

  StoresProvider._internal(
    super._createNotifier, {
    required super.name,
    required super.dependencies,
    required super.allTransitiveDependencies,
  ...
  @override
  Override overrideWith(
    FutureOr<List<Store>> Function(StoresRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: StoresProvider._internal(
        (ref) => create(ref as StoresRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  AutoDisposeFutureProviderElement<List<Store>> createElement() {
    return _StoresProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is StoresProvider && other.companyId == companyId;
  }
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin StoresRef on AutoDisposeFutureProviderRef<List<Store>> {
  /// The parameter `companyId` of this provider.
  String get companyId;
}

class _StoresProviderElement
    extends AutoDisposeFutureProviderElement<List<Store>> with StoresRef {
  _StoresProviderElement(super.provider);

  @override
  String get companyId => (origin as StoresProvider).companyId;
}
