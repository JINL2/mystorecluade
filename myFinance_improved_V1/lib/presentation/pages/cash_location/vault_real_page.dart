...
class _VaultRealPageState extends ConsumerState<VaultRealPage> {
  ...
  Future<void> _loadMoreData() async {
    ...
    try {
      ...
      final newEntries = await service.getVaultReal(
        companyId: companyId,
        storeId: storeId,
        ...
        child: Row(
          children: [
            ...
            Text(
              ...
              style: TossTextStyles.body.copyWith(
                color: isNegative ? Colors.red : TossColors.gray800,
                fontWeight: FontWeight.w600,
                fontSize: 16,
              ),
            ),
...
class _VaultDetailBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalValue = realEntry.getTotalValue();
                  ...
                  if (realEntry.currencySummary.isNotEmpty) ...[
                    ...
                    ...realEntry.currencySummary.expand((currency) => 
                      currency.denominations
                        .where((d) => d.runningQuantity != 0) // Only show non-zero quantities
  ...
  Widget _buildRunningDenominationItem(VaultDenomination denomination, String symbol) {
    final isNegative = denomination.runningQuantity < 0;
        ...
        children: [
          Row(
            ...
            children: [
              ...
              // Running quantity
              Text(
                'Qty: ${denomination.runningQuantity}',
                style: TossTextStyles.body.copyWith(
                  fontWeight: FontWeight.w500,
                  fontSize: 14,
          ...
          Row(
            ...
            children: [
              ...
              if (denomination.dailyChange != 0)
                Container(
                  ...
                  child: Text(
                    ...
                    style: TossTextStyles.caption.copyWith(
                      color: denomination.dailyChange > 0 ? Colors.green : Colors.red,
                      fontSize: 12,
                      fontWeight: FontWeight.w500,
                    ),
                  ),
              ...
              // Running total
              Text(
                _formatCurrency(denomination.runningTotal, symbol),
                style: TossTextStyles.body.copyWith(
                  fontWeight: FontWeight.w600,
                  fontSize: 14,
                  color: isNegative ? Colors.red : Colors.black87,
