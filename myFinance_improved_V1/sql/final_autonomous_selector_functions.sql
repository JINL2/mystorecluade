-- =====================================================
-- FINAL AUTONOMOUS SELECTOR RPC FUNCTIONS
-- Perfectly aligned with actual SUPABASE database structure
-- =====================================================

-- =====================================================
-- GET ACCOUNTS FUNCTION (GLOBAL - NO COMPANY/STORE FILTER)
-- Based on actual 'accounts' table structure
-- =====================================================
...
BEGIN
    SELECT json_agg(
        json_build_object(
            ...
            'transactionCount', 0,  -- Default value since we don't calculate this
...
-- Based on actual 'cash_locations' table structure
-- =====================================================
...
BEGIN
    SELECT json_agg(
        json_build_object(
            ...
            'transactionCount', 0,  -- Default value
            'additionalData', json_build_object(
    ...
    WHERE 
        ...
        AND (
            ...
            OR store_id IS NULL  -- Company-wide locations
        )
...
-- Based on actual 'counterparties' table structure
-- =====================================================
...
-- Run these in Supabase to test the functions
-- =====================================================

-- Test accounts (global - no company/store needed)
-- SELECT get_accounts();
-- SELECT get_accounts('asset');
-- SELECT get_accounts('liability');

-- Test cash locations (use your actual company_id)
-- SELECT get_cash_locations('your-company-id-here');
-- SELECT get_cash_locations('your-company-id-here', 'your-store-id-here');
-- SELECT get_cash_locations('your-company-id-here', NULL, 'bank');

-- Test counterparties (use your actual company_id)
-- SELECT get_counterparties('your-company-id-here');
-- SELECT get_counterparties('your-company-id-here', 'your-store-id-here');
-- SELECT get_counterparties('your-company-id-here', NULL, 'customer');