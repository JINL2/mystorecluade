-- =============================================================================
-- VIEW: v_cash_location
-- Purpose: Comprehensive cash location view with proper vault integration
-- =============================================================================
-- This view consolidates cash location data from multiple sources:
-- 1. Journal lines (book value)
-- 2. Cashier amount lines (physical cash count)
-- 3. Vault amount lines (vault transactions with debit/credit)
-- 4. Bank amounts (bank balance records)
-- =============================================================================

-- Drop existing view if it exists
DROP VIEW IF EXISTS public.v_cash_location;

-- Create corrected view with complete vault integration
...
- Vault transactions (vault_amount_line with debit/credit)
